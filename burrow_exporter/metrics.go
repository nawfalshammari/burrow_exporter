...
var (
	...
	KafkaActiveBrokers = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			Name: "kafka_active_brokers",
			Help: "Number of active brokers as reported by burrow.",
		},
		[]string{"cluster"},
	)
)
...
func init() {
	...
	prometheus.MustRegister(KafkaActiveBrokers)
}
